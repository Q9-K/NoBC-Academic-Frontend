      ...
      <div class="right-panel">
        ...
        <div class="buttons" v-if="!editing">
          ...
          <el-tooltip
              ...
              placement="top-start"
            >
            <template #content> Twitter:<br/>{{ scholarProfile.twitter }} </template>
          ...
          <el-tooltip
              ...
              placement="top-start"
            >
            <template #content> Facebook:<br/>{{ scholarProfile.facebook }} </template>
...
import { ElMessage } from 'element-plus';
  ...
  export default {
    ...
    goToTwitter() {
      // const twitterUrl = this.links.find(link => link.id === 3)?.url;
      const Url = this.scholarProfile.twitter
      console.log("goto:",Url)
      if (Url) {
        window.open(Url, '_blank');
      }
    ...
    goToFaceBook() {
      // const twitterUrl = this.links.find(link => link.id === 3)?.url;
      const Url = this.scholarProfile.facebook
      console.log("goto:",Url)
      if (Url) {
        window.open(Url, '_blank');
      }
