<template>
    <div class="searchBox">
        <div class="searchMain">
            <h2>NOBC帮你理解科学</h2>
            <a-select v-model:value="value" show-search size='large' placeholder="Select a person" :options="options" class="select"
...
const emits = defineEmits(['formDataChange']);
const handleChange = function() {
  emits('formDataChange', value);
};
const handleBlur = () => {
    console.log('blur');
};
